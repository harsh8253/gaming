...
const navGroups: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Users / Hierarchy', icon: Users, to: '/users' },
    ...
    <div className="min-h-screen bg-[#f6f8fb] text-slate-900">
      ...
      >
        <div className="flex h-[72px] items-center border-b border-slate-100 px-5">
          {collapsed ? (
            <div className="mx-auto flex size-8 items-center justify-center rounded-lg bg-[#172554] text-sm font-bold text-white">
              W
            </div>
          ) : (
            <div className="flex items-center gap-2.5">
              <div className="flex size-8 items-center justify-center rounded-lg bg-[#172554] text-sm font-bold text-white">
                W
              </div>
        ...
        <div className="border-t border-slate-100 p-3">
          <button
            ...
            className="flex w-full items-center justify-center rounded-lg p-2 text-slate-400 hover:bg-slate-50 hover:text-slate-700"
      ...
      <div className={`transition-all ${collapsed ? 'lg:pl-[76px]' : 'lg:pl-[238px]'}`}>
        <header className="sticky top-0 z-20 flex h-[72px] items-center gap-3 border-b border-slate-200 bg-white/95 px-4 backdrop-blur md:px-7">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h1 className="mt-1 truncate text-[17px] font-semibold tracking-tight text-slate-950">
              {headerInfo.heading}
            </h1>
          </div>
          <div className="hidden items-center gap-2 md:flex">
            <div className="relative">
              ...
              <input
                ...
                className="h-9 w-52 rounded-lg border border-slate-200 bg-slate-50 pl-9 pr-3 text-[12px] outline-none placeholder:text-slate-400 focus:border-blue-300 focus:bg-white focus:ring-2 focus:ring-blue-100"
              />
              {showSearch && search && (
                <button
                  onClick={() => {
              ...
              {showSearch && search && (
                <div className="absolute right-0 top-11 w-72 rounded-xl border border-slate-200 bg-white p-2 shadow-xl">
        ...
        <main className="mx-auto max-w-[1600px] p-4 md:p-7">
          {notice && (
            <div className="mb-5 flex items-center justify-between rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-xs text-blue-800">
              <span>{notice}</span>
